...
public class PythonController {
	...
	final String api = "RGAPI-a6f07ea9-5b91-4cfe-b858-889457468f16";
	...
	@GetMapping("myInfo")
	public @ResponseBody MyInfo myInfo() {//@RequestParam String Summoner
		Summon summon = multiSearchService.multiSearchName("냄세제로");
		System.setProperty("python.import.site", "false");
		intPre = new PythonInterpreter();
		intPre.exec("from java.lang import System");
