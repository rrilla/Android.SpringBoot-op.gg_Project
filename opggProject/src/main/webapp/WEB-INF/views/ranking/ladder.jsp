                              ...
                              <li class="ranking-highest__item ranking-highest__item--big"
                                 ...
                                 <div class="ranking-highest__icon">
                                    <a href="//www.op.gg/summoner/userName=xunxunxuno"><div
                                       ...
                                       <img class="profile_img" src="//opgg-static.akamaized.net/images/profile_icons/profileIcon${rank.profileIconId}.jpg?image=q_auto:best&v=1518361200"  style="width: 100px; height:100px;"/>
                                    ...
                                    <div class="winratio">
                                       <div class="winratio-graph">
                                          <div
                                             ...
                                             style="width: <fmt:formatNumber value="${rank.win/(rank.win+rank.lose)}" type="percent"/>"></div>
                                          <div
                                       ...
                                       <span class="winratio__text"><fmt:formatNumber value="${rank.win/(rank.win+rank.lose)}" type="percent"/></span>
                                    </div>
                                 </div></li>
                           </c:when>
                           <c:when test="${rank.rno < 6 }">
                              <li class="ranking-highest__item " id="summoner-57541180"><div
                                 ...
                                 <div class="ranking-highest__icon">
                                    ...
                                    <img class="profile_img" src="//opgg-static.akamaized.net/images/profile_icons/profileIcon${rank.profileIconId}.jpg?image=q_auto:best&v=1518361200"  style="width: 49px; height: 49px;"/></a>
                        ...
                        <c:if test="${rank.rno > 6 }">
                           <tr class="ranking-table__row " id="summoner-83507930">
                              ...
                              <td
                                 ...
                                 href="//www.op.gg/summoner/userName=Gen+G+Khael">
                                 <img class="profile_img" src="//opgg-static.akamaized.net/images/profile_icons/profileIcon${rank.profileIconId}.jpg?image=q_auto:best&v=1518361200" /><span>${rank.summonerName }</span></a></td>
