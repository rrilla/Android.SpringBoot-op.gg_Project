      ...
      <div class="content">
         ...
         <div class="realContent">
               ...
               <div style="text-align: center; margin-top: -1px;">
                  <div class="box">
                     ...
                     <div class="most_champ" style="width: 100%; position: relative;">
                        ...
                        <c:if test="${!empty gameMyInfo.myChampion[1]}">
                           <div>
                        ...
                        <c:if test="${!empty gameMyInfo.myChampion[2]}">
                        <div>
            ...
            <div class="game_list" style="margin-top: 10px;">
                  ...
                  <div class="game_content" style="${game.inGameMyInfo.result eq 'Fail' ? 'background-color: #e2b6b3;' : 'background-color: #a3cfec;'} ">
                     ...
                     <div class="game_setting">
                        ...
                        <div class="summoner_spell">
                           <div class="spell">
                              <img src="../../resources/images/spell/${game.inGameMyInfo.spell1}.png" style="width: 22px;height: 22px;"/>
                           </div>
                           <div class="spell">
                              <img src="../../resources/images/spell/${game.inGameMyInfo.spell2}.png" style="width: 22px;height: 22px;"/>
                           </div>
                        </div>
                        <div class="runes">
                           <div class="rune">
                              <img src="../../resources/images/rune/${game.inGameMyInfo.rune}.png" />
                           </div>
               ...
               <div class="GameDetail" id="detail" style="display: none; width: 700px;" data-value=${status.count }>
                           ...
                           <table class="GameDetailTable Result-WIN">
                              ...
                              <c:forEach items="${game.gameSummonerList}" var="slist" begin="0" end="4">
                                 <tr class="Row first  isRequester">
                                    ...
                                    <td class="SummonerSpell Cell"><img src="../../resources/images/spell/${slist.spell1}.png" style="width: 16px;height: 16px;"/>
                                     <img src="../../resources/images/spell/${slist.spell2}.png" style="width: 16px;height: 16px;"/></td>
                                    <td class="Rune Cell">
